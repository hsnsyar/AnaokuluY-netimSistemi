...
{
    public partial class FrmOgrtDavranıslar : Form
    {
        public FrmOgrtDavranıslar()
        {
            InitializeComponent();
        }
        ...
        void davranıslistele()
        {
            //Veritabından Davranıslartablosunu getirir
        ...
        private void FrmOgrtDavranıslar_Load(object sender, EventArgs e)
        {
            listele();
            davranıslistele();
            ogrsec();
        ...
        private void BtnDavKaydet_Click(object sender, EventArgs e)
        {
            // veritabanına davranış kaydeden kod

            SqlCommand komut = new SqlCommand("Insert into TBL_DAVRANISLAR(OgrDavAdi,OgrDavSoyadi,OgrDavNo,OgrDavTC,OgrDavranış,OgrDavFoto) values (@p1,@p2,@p3,@p7,@p8,@p11)", bgl.baglanti());
            ...
            bgl.baglanti().Close();
            MessageBox.Show("Ögrenci Davranışı Eklendi", "Bilgi", MessageBoxButtons.OK, MessageBoxIcon.Information);
            listele();
        }
        ...
        private void BtnDavTemizle_Click(object sender, EventArgs e)
        {
            temizle();
        }
